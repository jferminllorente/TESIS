...
\subsection{Campos de los mensajes MSM}
	Todos los mensajes del tipo MSM tienen el mismo encabezado, que se puede observar en la Fig. \ref{fig:MSMheader}. El mismo esta formado por los campos siguientes.
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{/DGNSS/MSMheader.png}
...
\begin{description}[wide]
	...
	\item[Máscara de señales GNSS] Este campo será utilizado por el software decodificador para saber qué señales tienen mediciones disponibles en los mensajes enviados. Tiene 32 bits y se corresponden con los identificadores de señal del estándar RINEX 3.01 [cita a rinex?]. Entonces, si en las mediciones hay disponibilidad de una señal para al menos un satélite, el bit correspondiente a esta señal es seteado.
...
\begin{description}
	...
	\item[Tiempo de enganche de fase de portadora] Es un indicador del tiempo en el cual el receptor lleva enganchado de manera continua a una señal particular. En caso de que ocurra un salto de ciclo en el instante de toma de mediciones anterior, se debe resetear este campo a cero.
	\item[Indicador de ambigüedades de medio ciclo] En caso de transmitir mediciones de fase de portadora con polaridad no resuelta es necesario setear este campo para que el software decodificador tenga esa información. En caso de que el software decodificador no sea capaz de trabajar con estas ambigüedades, va a descartar estas mediciones.
