...
\subsection{Mensaje de la estación de referencia estacionaria}
	Existen tres mensajes para describir las estaciones de referencia que actuarán como bases.
%Esto mensajes son 
%\begin{itemize}
...
%	\item Tipo 1033: 
%\end{itemize}
	Los mismos difieren en sutilezas, por eso se desarrollarán los campos del mensaje 1005 en particular y luego se comentarán las diferencias que presentan los otros dos.
\begin{figure}[]
    \centering
