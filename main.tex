...
%\subfloat[Errores para la linea base en cada coordenada.]{%
 	...
 	\caption{Error ENU de línea base al inicio del ensayo.}
...
\end{subfigure}
\caption{Ensayo RTK con línea base nula operando a doble frecuencia, sistema GPS, antena SENyT, con siete satélites en vista.}
