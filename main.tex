...
\renewcommand{\maketitle}[0]{%
  \thispagestyle{empty}
    ...
    \begin{center}
      ...
      \hfill
      \begin{minipage}[t]{0.15\linewidth}
        \includegraphics[width=1\linewidth]{Images/logos/logo_fiunlp.png}
      \end{minipage}\\
    \end{center}
    \vspace{1cm}
    \begin{center}
...
%            para obtener el título de Ingeniero en Telecomunicaciones.
    ...
    \begin{minipage}[t]{0.9\linewidth}
        \vspace{.5cm}
        \centering
        \includegraphics[width=0.8\textwidth]{Images/logos/logoSenytByN.png}\\
...
\end{subfigure}
\caption{Ensayo de posicionamiento relativo con línea de base nula operando a doble frecuencia, sistema GPS, antena SENyT, con ocho satélites en vista y base Serie Q.}
...
\centering
 	...
 	\caption{Error ENU de línea base mientras intenta resolver ambigüedades. Ensayo RTK con línea de base nula y base Serie Q.}
...
\end{subfigure}
\caption{Ensayo RTK con línea de base nula operando a doble frecuencia, sistema GPS, antena SENyT, con diez satélites en vista y base Serie Q.}
...
\centering
 	...
 	\caption{Solución de posición relativa en coordenadas ENU mientras intenta resolver ambigüedades. Ensayo RTK con línea de base no nula y base Serie Q.}
...
\end{subfigure}
\caption{Ensayo RTK con línea de base no nula operando a doble frecuencia, sistema GPS, antena SENyT en base y antena \textit{u-blox} en rover, con nueve satélites en vista y base Serie Q.}
