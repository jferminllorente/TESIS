  ...
  \thispagestyle{empty}
    ...
    \begin{center}
      \begin{minipage}[t]{0.125\linewidth}
        \includegraphics[height=1\linewidth]{Images/logos/universidad-nacional-de-la-plata.eps}
      \end{minipage}      
      \hfill
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{/EnsayosUblox/ublox_foto.eps}
...
\chapter{Implementación de la transmisión de correcciones RTCM en un sistema embebido}\label{ch:Qseries}
...
\begin{figure}
    ...
    \caption{Foto del receptor serie Q desarrollado por SENyT.}
    \label{fig:Q}
\end{figure}
