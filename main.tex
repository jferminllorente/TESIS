...
\section{Receptor Serie Q como estación de referencia estacionaria}
...
\end{itemize}
	En particular, para la aplicación aquí tratada interesa la solución de mejor calidad, la misma se obtiene con observables de mas de cuatro satélites para que el receptor pueda validar la solución de posición con redundancia. Esta solución es etiquetada como solución con calidad $S_4$. 
	Ademas, se puede visualizar la solución de posición obtenida con cada una de las dos frecuencias (GPS $L_1$ y $L_2$) junto con la de velocidad en cada coordenada. Y por ultimo, existe un indicador de si hay sincronismo PPS, que en general es obtenido algunas épocas posteriores a haber conseguido una solución con calidad $S_4$. 
