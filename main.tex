...
\end{equation}
	No se especifica como resulta la DD para pseudorango ya que al considerar que el retardo instrumental se cancela solo tendremos ruido en este caso. En los errores adicionales de carácter aleatorio solo queda remanente el ruido ya que multicamino es cancelado en BRSD pues el angulo de incidencia de la señal es el mismo para ambos receptores, es decir, tienen el mismo multicamino.
\section{Resolución de ambigüedades en mediciones de fase de portadora}
Metiendo mediciones en diferencias es posible aislar los errores que ya se menciono que terminan siendo estimados en conjunto con las ambigüedades, de esta manera se aíslan las ambigüedades para que sean estimadas de manera casi individual, solo con la presencia del ruido de la medición. CREEEEO que al aislar de esta manera las ambigüedades sabemos que quedan enteras, solo queda N.lambda y ruido, antes teníamos otros términos que hacian que lo que se estimaba no fuese entero.
