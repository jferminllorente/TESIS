...
\subsection{Manejo de tiempos y sincronización en el receptor}
...
\subsection{Sincronización al tiempo GPS y corrección de las mediciones}
	Esto se hace haciendo mas de 100 (o menos) integracinoes de 10ms en cada segundo (instrucciones que envia navegación a adquisición). Paulatinamente hasta empezar a alargar o acortar las integraciones y asi lograr sincro.
